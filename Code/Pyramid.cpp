	...
	phi(adist(rng))
{
	...
	if (!IsStaticInitialized())
	{
		...
		auto pvs = std::make_unique<VertexShader>(gfx, L"Code/Shaders/ColorBlendVS.cso");
		auto pvsbc = pvs->GetBytecode();
		AddStaticBind(std::move(pvs));

		AddStaticBind(std::make_unique<PixelShader>(gfx, L"Code/Shaders/ColorBlendPS.cso"));
