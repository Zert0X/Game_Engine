	...
	phi(adist(rng))
{
	...
	{
		auto pvs = std::make_unique<VertexShader>(gfx, L"Code/Shaders/ColorIndexVS.cso");
		auto pvsbc = pvs->GetBytecode();
		AddStaticBind(std::move(pvs));

		AddStaticBind(std::make_unique<PixelShader>(gfx, L"Code/Shaders/ColorIndexPS.cso"));
